...
MinecraftHelper.prototype.eventHandlers.onLaunch = function (launchRequest, session, response) {
    var speechText = "Welcome to the Aromatherapy Skill. This skill helps you learn what essential oils to use for different situations in your life. After hearing a recipe you can also find the details listed in the Alexa App. You can ask questions like, what's the recipe for focus? ... Now, what can I help you with.";
...
MinecraftHelper.prototype.intentHandlers = {
    ...
    "AMAZON.StopIntent": function (intent, session, response) {
        var speechOutput = "Thanks for using AromaTherapy. Peace Be With you. Until next time";
