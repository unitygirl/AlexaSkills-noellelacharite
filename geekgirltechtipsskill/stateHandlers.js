...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            var message = 'Welcome to the Geek Girl tech tips podcast. You can say, play the audio to begin the podcast.';
        ...
        'AMAZON.StopIntent' : function () {
            var message = 'Thanks for listening and if you have any suggestions on topics just email them to noelle at geek girl marketing dot com.';
    ...
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to the Geek Girl tech tips podcast. You can say, play the audio to begin the podcast.';
        ...
        'AMAZON.HelpIntent' : function () {
            ...
            var message = 'You are listening to the Geek Girl tech tips podcast. You can say, Next or Previous to navigate through the playlist. ' +
