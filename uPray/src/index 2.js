...
MinecraftHelper.prototype.eventHandlers.onLaunch = function (launchRequest, session, response) {
    var speechText = "Welcome to the uPray Skill for Amazon Alexa. You can say things like, tell me a prayer for comfort or healing? ... Now, what can I help you with.";
...
MinecraftHelper.prototype.intentHandlers = {
    ...
    "AMAZON.StopIntent": function (intent, session, response) {
        var speechOutput = "For additional prayers, meditations and other spiritual resources, please visit us at silentunity.org, Goodbye";
    ...
    "AMAZON.HelpIntent": function (intent, session, response) {
        var speechText = "You can say things such as, tell me a prayer for work or thankfulness. or, you can say exit... Now, what can I help you with?";
